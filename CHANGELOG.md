...
- **Multi-agent SDW isolation guard.** A guard intended to block multi-agent Sovereign Data Workspace memory use until per-agent custody isolation lands (#822). Correction, 2026-08-07: this isolation does not yet hold across two agents sharing one host. Do not read this entry as shipped isolation, and do not rely on it for cross-agent memory confinement. Open defect: **IC-16**.
