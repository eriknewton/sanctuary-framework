...
- New to the server? Start with the module map at `server/src/README.md` (the 62-module index; 54 of 62 modules have a barrel; plus confusable-name disambiguations and the frozen-surface list)
