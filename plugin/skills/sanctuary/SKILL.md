...
description: >
  ...
  reporting, sovereignty handshakes, MCP-to-MCP federation, sovereignty auditing, or principal dashboard approval.
...
1. **Audit your posture** — Run `sanctuary/sovereignty_audit` to see your current sovereignty score, gaps, and prioritized recommendations.
...
3. **Generate your SHR** — Run `sanctuary/shr_generate` to create your first Sovereignty Health Report — a signed, machine-readable proof of your sovereignty capabilities.
