 ...
 * activation + node-count enforcement gate (PR-2).
 *
 ...
 *     state, and the CENTRAL fleet roster enforces the node-count cap. Payment
 *     processing / self-serve remains out of scope. Enforcement is fail-closed to
 *     community on any failure and NEVER gates a node's Castle Wall, its local
 *     dashboard, or free policy-push (PR-2).
 */
