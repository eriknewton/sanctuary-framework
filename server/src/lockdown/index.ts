 ...
 *
 * The coarse global write-freeze flag. One on-disk record at
 ...
 * fortress-wide boolean (reads permitted, writes blocked), not the
 * per-operation graduated consent the gate owns.
 */
