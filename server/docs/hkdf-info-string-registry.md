...
|---|---|---|---|
| undefined (passphrase context) | `sanctuary-passphrase-v1` | `server/src/wrap/passphrase.ts:581` | Final master-key derivation step in the passphrase flow. The Argon2id output is fed to HKDF with this info string to produce the 32-byte master key. |
