...
| `sdw-owner-pin-mac` | `server/src/sdw/write-gate.ts` | `SDW_OWNER_PIN_MAC_INFO` | MAC key for the persisted SDW owner pin in `_sdw_meta` (multi-agent isolation guard). **(added 2026-08-22; MAC/crypto-domain label.)** |
