...
(`Review/Sanctuary/Inert_Capability_Sweep_2026-08-07.md`). It does not load a
...
- Linux kernel-binding modules for nftables, cgroup v2, and NFQUEUE. They are
  ...
  **IC-02, IC-04** (`Review/Sanctuary/Inert_Capability_Sweep_2026-08-07.md`).
...
are fixed (`Review/Sanctuary/Inert_Capability_Sweep_2026-08-07.md`). Today the
